...
public class RequestServiceImplTest {
    ...
    public void checkGetOtherRequest() {
        ...
        assertThat(requestService.getOthersRequests(user1.getId(), 0, 20))
                .isNotNull()
                .usingRecursiveComparison()
                .isEqualTo(List.of());
    }
    ...
    public void getOtherRequestShouldThrowExceptionIfFromAndAndSizeIsNegative() {
        assertThrows(IllegalArgumentException.class, () -> requestService.getOthersRequests(user1.getId(), -1, -20));
    }
